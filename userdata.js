...
function result() {
 ...
 function validate() {
    ...
    if( document.RegisterForm.ReEnterPassword.value != document.RegisterForm.password.value) {
        alert( "Please Re Enter the password corrctly!" );
        return false;
     }
    return( true );
 }
 ...
 function fun()
 {
     if(validate()){
        ...
        //document.location.href = 'questionarie.html',true;
     }
